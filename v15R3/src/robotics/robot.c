 ...
 * TRUTH-MESH: verified by direction of travel. SDK-standard X pattern:
 * FL +45°, FR -45°, BL -45°, BR +45°. With SDK IK (FL: f+s+r, FR: f-s-r,
 * BL: f-s+r, BR: f+s-r), +strafe drives +X (robot-left). */
